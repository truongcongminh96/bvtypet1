  ...
  return (
    <section className="border-y border-border bg-background py-14 sm:py-16 lg:py-20">
      <div className="shell">
        ...
        <MotionGroup className="mt-8 grid gap-6">
          {items.slice(0, 3).map((location, index) => (
            <MotionItem key={location.id}>
              <article className="grid overflow-hidden rounded-[var(--radius-lg)] border border-border bg-surface shadow-[var(--shadow-card)] lg:grid-cols-2">
                <div className={`relative min-h-[17rem] bg-surface-warm ${index % 2 === 1 ? "lg:order-2" : ""}`}>
                ...
                <div className="p-6 sm:p-7 lg:p-8">
                  ...
                  <Link href={location.mapUrl} target="_blank" rel="noreferrer" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-brand-blue-dark">
